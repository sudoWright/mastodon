...
gem 'active_model_serializers', '~> 0.10', '>= 0.10.7'
gem 'addressable', '~> 2.5'
gem 'bootsnap', '~> 1.3'
gem 'browser'
...
group :pam_authentication, optional: true do
  gem 'devise_pam_authenticatable2', '~> 9.1', '>= 9.1.0'
end
...
gem 'sidekiq-scheduler', '~> 2.2', '>= 2.2.1'
gem 'sidekiq-unique-jobs', '~> 5.0', '>= 5.0.10'
